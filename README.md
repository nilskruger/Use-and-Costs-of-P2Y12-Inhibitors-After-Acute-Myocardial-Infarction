...
Primary analyses were conducted using claims-based and publicly available data sources from Germany and the United States, including **BARMER Krankenkasse Scientific Data Warehouse / Wissenschafts-Data-Warehouse**, **Optum Clinformatics**, **Merative MarketScan**, **CMS Open Payments**, and **Medicare Part D Prescriber Public Use Files**.
